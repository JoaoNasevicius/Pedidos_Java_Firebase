...
/*
	public static void main(String[] args) throws FirebaseException, JsonParseException, JsonMappingException, IOException, JacksonUtilityException {
		...
		String firebase_baseUrl = "https://projetoteste-9d563.firebaseio.com/";
//		for( String s : args ) {
		...
		Map<String, Object> dataMap0 = new LinkedHashMap<String, Object>();
		...
		dataMap0 = (Map<String, Object>) response.getBody();
		dataMap0.put("Tetinha", "Viaje");
		firebase.put(dataMap0);
		//		System.out.println(dataMap0);
//		dataMap1 = (Map<String, Object>) dataMap0.get((String) "Teste0");
//		dataMap1.put("Teste1", "Mudou sem apagar 2");
//		dataMap0.put("Teste0", dataMap1);
//		firebase.put(dataMap0);
		
/*
		// "PUT" (test-map into the fb4jDemo-root)
		Map<String, Object> dataMap = new LinkedHashMap<String, Object>();
		dataMap.put( "PUT-rootSurubao", "This was PUT into the fb4jDemo-root" );
